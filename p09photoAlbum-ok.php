...
<?php include 'builder-header.php';?>
	...
	<section class="p09photoAlbum section-builder" id="p09photoAlbum">
	<h2 class="section-title section-title__build">Фотоальбомы Love Story, The Wedding Day</h2>
...
<!-- @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ -->
		...
		<div class="p09photoAlbum-photos">
			<!-- <div class="photo-blok"> -->

		<div class="p09photoAlbum-photos-ib p09photoAlbum-photos-vblock">
			<div class="p09photoAlbum-photos-bl">
				<div class="p09photoAlbum-photos-ib">
					<img class=" magnify" src="img/foto/photo01.jpg" alt="">
				</div>
				
				<div class="p09photoAlbum-photos-ib">
					<img class="w50 magnify" src="img/foto/photo02.jpg" alt="">
				</div>
			</div>

			<div class="p09photoAlbum-photos-bl">
				<img class="fl50 magnify" src="img/foto/photo03.jpg" alt="">
			</div>
		</div>

		<div class="p09photoAlbum-photos-ib p09photoAlbum-photos-vblock">
			<img class="magnify" src="img/foto/photo04.jpg" alt="">
		</div>


		<div class="p09photoAlbum-photos-ib p09photoAlbum-photos-vblock">
			<div class="p09photoAlbum-photos-bl">
				<img class="fl50 magnify" src="img/foto/photo05.jpg" alt="">
			</div>
			<div class="p09photoAlbum-photos-bl">
				<img class="fl50 magnify" src="img/foto/photo06.jpg" alt="">
			</div>
		</div>

		<div class="p09photoAlbum-photos-ib p09photoAlbum-photos-vblock">
			<img class="magnify" src="img/foto/photo07.jpg" alt="">
		</div>

		<div class="p09photoAlbum-photos-ib p09photoAlbum-photos-vblock">
			<div class="p09photoAlbum-photos-bl">
				<img class="fl50 magnify" src="img/foto/photo08.jpg" alt="">
			</div>

			<div class="p09photoAlbum-photos-bl">

				<div class="p09photoAlbum-photos-ib">
					<img class="fl50 magnify" src="img/foto/photo09.jpg" alt="">
				</div>
				<div class="p09photoAlbum-photos-ib">
					<img class="fl50 magnify" src="img/foto/photo10.jpg" alt="">
				</div>
